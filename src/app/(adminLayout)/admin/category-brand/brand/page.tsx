  ...
  return (
    <div className="p-6 space-y-8">
      ...
      <div className="grid md:grid-cols-3 gap-6">
        <Card className="bg-gradient-to-r from-blue-500/10 to-blue-100 shadow-lg dark:blue- dark:border-gray-600">
        ...
        <Card className="bg-gradient-to-r from-green-500/10 to-green-100 shadow-lg  dark:border-gray-600">
          <CardContent className="flex justify-between items-center p-6">
            <div>
              <p>Current Page</p>
      ...
      <Card>
        <CardContent className="p-4 flex justify-between gap-4">
          ...
          <Button className="bg-red-700 dark:text-white dark:hover:bg-white dark:hover:text-black">
